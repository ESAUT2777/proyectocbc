<?php
class User{
    private $dbHost     = "bqsi5qvhtw94wy7jlelf-mysql.services.clever-cloud.com";
    private $dbUsername = "up2wjqihx6mpndkf";
    private $dbPassword = "fIPXckTHX1w5XF0vKHc2";
    private $dbName     = "bqsi5qvhtw94wy7jlelf";
